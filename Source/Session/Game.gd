...
@export var start_timestamp = Time.get_unix_time_from_system()
...
var time_dict = Time.get_datetime_dict_from_unix_time(start_timestamp)
var current_time = "%04d-%02d-%02d %02d:%02d:%02d" % [time_dict.year, time_dict.month, time_dict.day, time_dict.hour, time_dict.minute, time_dict.second]
